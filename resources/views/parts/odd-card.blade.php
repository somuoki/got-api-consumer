            ...
            <div class="flex items-start justify-between w-full">
                <div class="pl-3 w-full">
                    ...
                    <p tabindex="0" class="focus:outline-none text-sm leading-normal pt-2 text-gray-500">
                        @if($specific['comment_count'] != null){{ $specific['comment_count'] }} Comments @endif
                        @if($specific['founded'] != null) Founded In {{ $specific['founded'] }} To {{ $specific['diedOut'] }} @endif
                        @if($specific['gender'] != '')Gender {{ $specific['gender'] }} Age {{ $specific['age'] }} @endif
                    </p>
                </div>
