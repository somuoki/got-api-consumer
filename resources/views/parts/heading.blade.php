    ...
    <div class="bg-white rounded shadow-lg py-5 px-7">
        <nav class="flex justify-between">
            <div class="flex items-center space-x-3 lg:pr-16 pr-6">
                ...
                <h2 class="font-normal text-2xl leading-6 text-gray-800">{{ $title }}</h2>
            </div>

            <!-- For medium and plus sized devices -->
            <ul class="hidden md:flex flex-auto space-x-2">
                <li class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 @if(Route::currentRouteName() == 'home') bg-indigo-600  text-white @else text-gray-600 bg-gray-50 @endif  cursor-pointer px-3 py-2.5 font-normal text-xs leading-3 shadow-md rounded">
                    <a href="/">Home</a></li>
                <li class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 border border-white @if(Route::currentRouteName() == 'books') bg-indigo-600  text-white @else text-gray-600 bg-gray-50 @endif cursor-pointer px-3 py-2.5 font-normal text-xs leading-3 shadow-md rounded">
                    <a href="/books">Books</a> </li>
                <li class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 border border-white @if(Route::currentRouteName() == 'houses') bg-indigo-600  text-white @else text-gray-600 bg-gray-50 @endif cursor-pointer px-3 py-2.5 font-normal text-xs leading-3 shadow-md rounded">
                    <a href="/houses">Houses</a> </li>
                <li class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 border border-white @if(Route::currentRouteName() == 'characters') bg-indigo-600  text-white @else text-gray-600 bg-gray-50 @endif cursor-pointer px-3 py-2.5 font-normal text-xs leading-3 shadow-md rounded">
        ...
        <div class="block md:hidden w-full mt-5 ">
            <div onclick="selectNew()" class="cursor-pointer px-4 py-3 text-white bg-indigo-600 rounded flex justify-between items-center w-full">
                <div class="flex space-x-2">
                    <span id="s1" class="font-semibold text-sm leading-3 hidden">Selected: </span><p id="textClicked" class="font-normal text-sm leading-3 focus:outline-none hover:bg-gray-800 duration-100 cursor-pointer "></p>
                </div>
            ...
            <div class=" relative">
                <ul id="list" class=" hidden font-normal text-base leading-4 absolute top-2  w-full rounded shadow-md">
                    <li class="px-4 py-3 text-gray-600 bg-gray-50 border border-gray-50 focus:outline-none focus:bg-gray-100 hover:bg-gray-100 duration-100 cursor-pointer text-xs leading-3 font-normal">Home</li>
                    <li class="px-4 py-3 text-gray-600 bg-gray-50 border border-gray-50 focus:outline-none focus:bg-gray-100 hover:bg-gray-100 duration-100 cursor-pointer text-xs leading-3 font-normal">Books</li>
                    <li class="px-4 py-3 text-gray-600 bg-gray-50 border border-gray-50 focus:outline-none focus:bg-gray-100 hover:bg-gray-100 duration-100 cursor-pointer text-xs leading-3 font-normal">Houses</li>
                    <li class="px-4 py-3 text-gray-600 bg-gray-50 border border-gray-50 focus:outline-none focus:bg-gray-100 hover:bg-gray-100 duration-100 cursor-pointer text-xs leading-3 font-normal">Character</li>
                </ul>
            </div>
        </div>
    </div>
